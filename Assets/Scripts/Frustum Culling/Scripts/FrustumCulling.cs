...
public class FrustumCulling : MonoBehaviour
{
    ...
    [Range(10f, 360f), Tooltip("The rotation speed (in degrees) at which the restingFrames reaches 0. Higher values means the system will be less sensitive to camera rotation speed.")]
    public float rotationMaxSpeed = 40f;
    ...
    void Awake()
    {
        ...
        lastCamRotation = mainCam.transform.rotation;
    ...
    void UpdateDynamicFrameRate()
    {
        rotationSpeed = Quaternion.Angle(lastCamRotation, mainCam.transform.rotation);
        lastCamRotation = mainCam.transform.rotation;

        float speed01 = Mathf.Clamp01(rotationSpeed / rotationMaxSpeed);

        float t = 1f - speed01;

        runEveryFrames = Mathf.RoundToInt(Mathf.Lerp(minFrames, maxFrames, t));
    }
