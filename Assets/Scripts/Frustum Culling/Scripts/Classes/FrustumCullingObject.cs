...
namespace Utilities
{
    ...
    {   
        ...
        public void BuildEdges()
        {
            ...
            Transform parentEdges = transform.Find("FrustumEdges");
            if (parentEdges == null)
            {
                GameObject container = new GameObject("FrustumEdges");
                container.transform.parent = transform;
                container.transform.localPosition = Vector3.zero;
                parentEdges = container.transform;
            }
            else
            {
                for (int i = parentEdges.childCount - 1; i >= 0; i--)
                {
                    DestroyImmediate(parentEdges.GetChild(i).gameObject);
                }
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                go.transform.parent = parentEdges;
