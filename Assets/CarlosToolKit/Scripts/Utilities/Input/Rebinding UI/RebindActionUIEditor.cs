...
public class RebindActionUIEditor : UnityEditor.Editor
{
    ...
    {
        excludeMouseButtonsProperty = serializedObject.FindProperty("excludeMouseButtons");
        ...
        m_CaptionTextProperty = serializedObject.FindProperty("m_CaptionText");
    ...
    public override void OnInspectorGUI()
    {
        ...
        using (new EditorGUI.IndentLevelScope())
        {
            ...
            EditorGUILayout.PropertyField(excludeMouseButtonsProperty);
        ...
        using (new EditorGUI.IndentLevelScope())
        {
            ...
            EditorGUILayout.PropertyField(m_CaptionTextProperty);
        }
    ...
    private SerializedProperty excludeMouseButtonsProperty;
    ...
    private SerializedProperty m_CaptionTextProperty;
